    ...
    with st.container():
        ...
        with col5:
            ...
            with st.form(key='test_connection', border=False):
                # 创建按钮
                st.session_state[page_name]['test_connect_button'] = st.form_submit_button(label='Test Connection',
    ...
    with st.container():
        ...
        with col4:
            ...
            with st.form(key='build', border=False):
                # 创建按钮
                st.session_state[page_name]['build_button'] = st.form_submit_button(label='Build',
                                                                                    use_container_width=True)
