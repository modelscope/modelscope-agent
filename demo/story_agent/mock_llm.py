...
RESPONSE = [
    ...
    """好的，我为您生成的故事如下：在一天阳光明媚的早晨，小男孩Tommy和他的狗Max在后院发现了一个被风吹来的神秘地图。地图上标记着一条通向森林深处的路线，一颗大大的"X"标记在地图的另一头。
    ...
    """ """,
    """很高兴你喜欢！接下来，我们可以开始创建故事的插图。你更喜欢哪种风格的插图？是手绘风格，还是数字艺术风格？具体图片如右图
