...
from modelscope_agent.utils.qwen_agent.schema import ASSISTANT, DEFAULT_SYSTEM_MESSAGE, SYSTEM, USER, FUNCTION, Message
...
from modelscope_agent.utils.qwen_agent.utils import (extract_text_from_message, format_as_multimodal_message, format_as_text_message,
    ...
    def __init__(self, cfg: Optional[Dict] = None):
        ...
        if cache_dir:
            try:
                ...
                logging.warning('Caching disabled because diskcache is not installed. Please `pip install diskcache`.')
                cache_dir = None
        if cache_dir:
