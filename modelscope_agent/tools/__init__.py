...
_import_structure = {
    ...
    'dashscope_tools': ['ImageEnhancement', 'TextToImageTool',
                        'ParaformerAsrTool', 'QWenVL', 'SambertTtsTool',
                        'StyleRepaint', 'WordArtTexture'],
    'doc_parser': ['DocParser'],
    'hf_tool': ['HFTool'],
    'langchain_proxy_tool': ['LangchainTool'],
    'modelscope_tools': ['ImageChatTool', 'ModelscopePipelineTool',
                         'TextAddressTool', 'TextInfoExtractTool',
                         'TextNerTool', 'TexttoSpeechTool', 'TextToVideoTool',
                         'TranslationEn2ZhTool', 'TranslationZh2EnTool'],
