...
def build_system_prompt(folder_path, schema_path, language="python"):
    primary_system_prompt_path = os.path.join(
        folder_path, language, "system_prompt_primary.txt"
    )
    cypher_system_prompt_path = os.path.join(
        folder_path, language, "system_prompt_cypher.txt"
    )
