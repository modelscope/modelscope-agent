...
from groundingdino.util.misc import (NestedTensor, accuracy, get_world_size,
...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List = None, **kw):
        ...
        if text_self_attention_masks.shape[1] > self.max_text_len:
            ...
            tokenized['input_ids'] = tokenized['input_ids'][:, :self.
                                                            max_text_len]
            tokenized['attention_mask'] = tokenized[
                'attention_mask'][:, :self.max_text_len]
            tokenized['token_type_ids'] = tokenized[
                'token_type_ids'][:, :self.max_text_len]
