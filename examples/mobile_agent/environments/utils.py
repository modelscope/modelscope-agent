...
def det(input_image, text_prompt, groundingdino_model, box_threshold=0.07, text_threshold=0.5):
...
def generate(image_file, query):
    ...
    response = MultiModalConversation.call(model='qwen-vl-plus', messages=messages, api_key=os.getenv('DASHSCOPE_API_KEY'))
