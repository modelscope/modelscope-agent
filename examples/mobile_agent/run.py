...
parser.add_argument('--instruction', type=str, default="Tell me today's weathers")
...
groundingdino_dir = [os.path.join(args.groundingdino_dir, 'config/GroundingDINO_SwinT_OGC.py'), 
